...
/**
 * Check if Value is Lower or Equal
 */
class isLowerOrEqual extends AbstractRule
{
    //====================================================================//
    // DEFINITION
    //====================================================================//
    ...
    {
        return "Basic check if value is Lower or Equal to Constraint";
    }
    ...
    public function verify($value): bool
    {
        ...
        foreach (RulesHelper::getLevelCriteria($this->options, "lte") as $level => $constraint) {
            ...
            $result &= $this->log($level, "Value is not lower or equal to ".print_r($constraint, true), array($value));
            if (!$result) {
                return false;
            }
        }
